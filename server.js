...
// --- DATA STRUCTURES ---
const CROPS = ['rice', 'soybean', 'cotton', 'wheat', 'groundnut', 'maize', 'sorghum', 'millet', 'chickpea'];
...
const i18n = {
    en: {
        ...
        cropNames: {
            'rice': 'Rice (Paddy)', 'soybean': 'Soybean', 'cotton': 'Cotton', 
            'wheat': 'Wheat', 'groundnut': 'Groundnut', 'maize': 'Maize', 
            'sorghum': 'Sorghum', 'millet': 'Millet', 'chickpea': 'Chickpea',
            'coriander': 'Coriander', 'cucumber': 'Cucumber', 'mustard': 'Mustard', 'pulses': 'Pulses'
        },
        baseRules: {
